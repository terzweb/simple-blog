...
define('ADMIN_TITLE','terzwebBlog');
define('ADMIN_TITLE_MINI','TWB');

define('ADMINURL','manager');

/************************** EMAIL CONSTANTS *****************************/

define('EMAIL_FROM', '');		// e.g. email@example.com
...
define('MAIL_PATH', '/usr/lib/sendmail');