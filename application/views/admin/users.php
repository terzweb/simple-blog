        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url('admin'); ?>/adduser"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin').'/login-history/'.$record->userId; ?>" title="Login history"><i class="fa fa-history"></i></a> | 
